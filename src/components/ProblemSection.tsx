        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 relative">
            <div className="relative">
              <div className="absolute -top-6 -left-6 w-32 h-32 bg-emerald-50 rounded-full opacity-60 blur-2xl"></div>
              <div className="relative rounded-sm overflow-hidden shadow-stripe-xl border border-[#e5edf5]">
                <img src="/aerial-solar.jpg" alt="Overzicht van Nederlandse wijk met zonnepanelen" className="w-full h-80 object-cover" />
              </div>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="bg-white rounded-sm p-6 border border-[#e5edf5] shadow-stripe-sm">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-3 h-3 bg-emerald-500 rounded-full"></div>
                  <h3 className="font-medium text-[#061b31]">Nu</h3>
                </div>
                <p className="text-sm text-[#64748d]">Stroom die je levert, trek je later gratis terug in.</p>
              </div>
              <div className="bg-white rounded-sm p-6 border border-[#e5edf5] shadow-stripe-sm">
                <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm text-[#64748d]">Je krijgt €0,06/kWh terwijl je €0,35 betaalt.</p>
              </div>
            </div>
          </div>
        </div>
