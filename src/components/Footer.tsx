      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="#" className="hover:text-emerald-400 transition-colors">KOR-regeling</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500">
            &copy; {new Date().getFullYear()} ThuisBatterij.nl - Alle rechten voorbehouden
          </p>
          <div className="flex gap-6 text-sm text-slate-500">
            ...
            <a href="#" className="hover:text-slate-300 transition-colors">Cookiebeleid</a>
          </div>
        </div>
      </div>
    </footer>
