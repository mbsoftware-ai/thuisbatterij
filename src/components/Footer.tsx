      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-sm text-gray-500">
            <a href="#" className="hover:text-gray-300 transition-colors">Privacybeleid</a>
            <a href="#" className="hover:text-gray-300 transition-colors">Algemene voorwaarden</a>
            <a href="#" className="hover:text-gray-300 transition-colors">Cookiebeleid</a>
          </div>
        </div>
      </div>
    </footer>
